...
swiperMain.on("sliderChangeTransitionEnd", updateCardInput);
...
const phoneValidateOption = {
    format: {
        ...
        message:
            'Номер телефона должен соответствовать формату: "xxxxxxxxxxxxx"',
    },
};
...
form.addEventListener("submit", async (event) => {
    ...
    const errors = validate(form, {
        send_phone: phoneValidateOption,
